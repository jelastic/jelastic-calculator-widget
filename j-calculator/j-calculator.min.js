...
jQuery(document).ready(function ($) {
  ...
  function setPrice(reservedTiers, scalingTiers, el, storageTiers, ipTiers, trafficTiers) {
    ...
    trafficPrice = trafficPrice * usdRate; // TO CURRENCY

    trafficPrice = toCurrency(trafficPrice, currencySettings.usdRate);
    minPrice = minPrice + storagePrice + ipPrice; // TO USD

    minPrice = minPrice * usdRate; // TO CURRENCY
    ...
    maxPrice = maxPrice + storagePrice + ipPrice; // TO USD

    maxPrice = maxPrice * usdRate; // TO CURRENCY
