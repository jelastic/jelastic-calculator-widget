...
window.jCalculator = (function (that) {
    ...
    that.renderHosterSelector = function(el) {
        ...
        $(el).find('.hoster-selector--select').each(function () {
            ...
            for (var i = 0; i < numberOfOptions; i++) {
                ...
                var loc = $this.children('option').eq(i).attr('data-location').split(',').filter(that.onlyUnique);
            ...
            $listItems.click(function (e) {
                ...
                sCurrentHoster = $(this).attr('rel');
                that.renderHosterSelector(calculatorElement);
                that.renderCalculator(calculatorElement);
    ...
    that.onlyUnique = function(value, index, self) {
